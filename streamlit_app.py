...
st.set_page_config(page_title="Der weibliche Zyklus", page_icon="🌹", layout="wide") # layout = wide -> Inhalt nimmt fast ganze Fensterbreite ein
...
with start:
    ...
    if quellen_anzeigen == "Ja, gerne!":
        ...
        st.info("""Bereich 'Fruchtbarkeitswahrscheinlichkeit':
                ...
                file:///h:/win.v2/Downloads/978-3-0o31-58516-6.pdf (26.05.2025)
